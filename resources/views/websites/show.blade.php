    ...
    @if ($website->isGenerated())
        <div class="card">
            <div class="actions" style="justify-content: space-between; margin-bottom: .8rem;">
                ...
                <a class="btn secondary" target="_blank" href="{{ route('websites.preview', $website) }}">Open full screen ↗</a>
            </div>
            <iframe class="preview" src="{{ route('websites.preview', $website) }}" title="Website preview"></iframe>
        </div>
